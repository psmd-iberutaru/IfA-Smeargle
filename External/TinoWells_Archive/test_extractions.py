...
# python test_extractions.py -ddir Tutorial/190510_T40K_2hrdark_set2

# mkdir Subarrays && mv subarray_*.fits Subarrays
# mkdir Plots && mv *.pdf Plots
# mkdir Full_Arrays && mv *.fits Full_Arrays
...
def extract_subarrays(fullarray):
    with fits.open(fullarray) as hdu:
