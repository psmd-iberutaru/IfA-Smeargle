...
class YankeeConfig(BaseConfig):
    ...
    The YANKEE line is mostly responsible for holding, storing, and reading of configuration
    files and classes that dictate the rest  of the module's behavior. 
