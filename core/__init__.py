...
from IfA_Smeargle.core import errors as error
...
# This is an alias, the runtime constants are really defined in the main
# folder, but, it is kind of a core object.
